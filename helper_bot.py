...
class HelperPanelBot:
    ...
    def build_page(
        ...
        if page == "panel_page2":
            text = (
                f"{notice_text}"
                "🧩 پنل مدیریت سلف — صفحه ۲\n"
                "━━━━━━━━━━━━━━\n\n"
                "قابلیت موردنظر را انتخاب کنید:"
            )
            keyboard = InlineKeyboardMarkup([
                [
                    glass_button("👥 مدیریت گروه", owner_id, "groups_new", style="success"),
                    glass_button("😀 ایموجی آنلاین/آفلاین", owner_id, "appearance", style="primary"),
                ],
                [
                    glass_button("✏️ محافظ ویرایش", owner_id, "security", style="primary"),
                    glass_button("💚 دوست/دشمن", owner_id, "relationships", style="success"),
                ],
                [
                    glass_button("🗑️ محافظ حذف", owner_id, "general", style="danger"),
                    glass_button("❤️ ری‌اکشن خودکار", owner_id, "automation", style="primary"),
                ],
                [
                    glass_button("⚡ اکشن‌ها", owner_id, "messages", style="primary"),
                    glass_button("💱 قیمت ارز", owner_id, "tools", style="success"),
                ],
                [
                    glass_button("◀️ صفحه قبل", owner_id, "home", style="primary"),
                    glass_button("▶️ صفحه بعد", owner_id, "panel_page3", style="primary"),
                ],
            ])
        ...
        if page == "panel_page3":
            ...
            keyboard = InlineKeyboardMarkup([
                [
                    glass_button("🎤 متن به ویس", owner_id, "tools", style="primary"),
                    glass_button("👤 چک کردن پروفایل", owner_id, "profiles", style="success"),
                ],
                [
                    glass_button("🧮 ماشین حساب", owner_id, "tools", style="primary"),
                    glass_button("🎬 انیمیشن‌ها", owner_id, "messages", style="primary"),
                ],
                [
                    glass_button("📊 وضعیت", owner_id, "stats_new", style="success"),
                    glass_button("🏓 پینگ", owner_id, "panel_ping", style="primary"),
                ],
                [
                    glass_button("◀️ صفحه قبل", owner_id, "panel_page2", style="primary"),
                ],
            ])
            return text, keyboard
        ...
        if page == "home":
            ...
            keyboard = InlineKeyboardMarkup([
                [
                    glass_button("🤖 منشی", owner_id, "secretary", style="primary"),
                    glass_button("🧾 فرم‌ساز پیوی", owner_id, "forms", style="success"),
                ],
                [
                    glass_button("🟢 حالت آنلاین", owner_id, "appearance", style="primary"),
                    glass_button("📝 حالت متن", owner_id, "appearance", style="primary"),
                ],
                [
                    glass_button("💬 کامنت اول", owner_id, "automation", style="success"),
                    glass_button("🕒 ساعت", owner_id, "appearance", style="primary"),
                ],
                [
                    glass_button("🔐 قفل پیوی", owner_id, "security", style="danger"),
                    glass_button("✍️ امضا پیام", owner_id, "appearance", style="primary"),
                ],
                [
                    glass_button("▶️ صفحه بعد", owner_id, "panel_page2", style="primary"),
                ],
            ])
            return text, keyboard
        ...
        if page == "extras":
            ...
            text = (
                ...
                + (
                    ...
                    "• ترجمه، TTS، قیمت ارز و ماشین حساب در ابزارها قرار دارند. "
