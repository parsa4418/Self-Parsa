...
class HelperPanelBot:
    ...
    def run(self) -> None:
        # Render Web Service: use webhook instead of polling
        port = int(os.getenv("HELPER_PORT", "10001"))
        ...
        path = os.getenv("HELPER_WEBHOOK_PATH", "helper")
        secret = os.getenv("HELPER_WEBHOOK_SECRET", "")
